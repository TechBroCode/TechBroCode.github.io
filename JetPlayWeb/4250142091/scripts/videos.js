...
let premiumVideoAdsList = [["https://techbrocode.github.io/JetPlayWeb/storage/colgate.mp4", `video/mp4; codecs="avc1.64001E, mp4a.40.2"`, "https://yt3.googleusercontent.com/Xj-6gqHKmTewewCwB6zMzywmZuQJgn0OMH5FEPt_NVTx-XehTx8l3NOsau5FZ4pO-HhcbdDd=s900-c-k-c0x00ffffff-no-rj", "Colgate", "Open" // Ads action button text
]];
    ...
    .then(responseData => {
        if (responseData !== null && responseData.length !== 0) {
            ...
            for (let i = 0; i < premiumVideoAdsJsonList.length; i++) {
                if (Date.now() >= premiumVideoAdsJsonList[i].expiry_date) {
